...
-- Note: an earlier commit message on production referenced a repo file
-- 20260822080000_complete_enrollment_reconcile_stk_payments.sql for design rationale, but no
-- such file exists in this repository -- reconstructed here directly from the applied SQL.
