...
-- marks, same fix: literal OR of the original expressions, copied verbatim from
-- pg_policies, so this changes evaluation cost, not evaluation result.
...
-- confirmed to be the exact OR of the originals, expression-for-expression; RLS
-- confirmed still enabled with the expected reduced policy count (7 -> 3).
--
