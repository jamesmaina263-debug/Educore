            ...
            <div key={r.id} className="rounded-md border border-border p-4">
              <div className="mb-2 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Badge variant="secondary">{r.review_type}</Badge>
                  <span className="text-sm text-muted-foreground">{r.period_label}</span>
                </div>
                {r.overall_rating !== null && <p className="text-sm font-medium">Overall: {r.overall_rating}/5</p>}
              </div>
